...
namespace carometro.webapi.Utils
{
    public static class Upload
    {
        ...
        public static string UploadFile(IFormFile arquivo, string[] extensoesPermitidas, string urlImg)
        {
            try
            {
